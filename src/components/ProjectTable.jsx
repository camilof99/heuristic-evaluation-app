            ...
            <div className="flex items-center justify-between pb-4">
                <div>
                    <button
                        ...
                        type="button"
                        className="text-white bg-gradient-to-r from-purple-800 via-purple-800 to-purple-900 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-500 dark:focus:ring-purple-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2"
                    >
                        <svg
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        >
                            ...
                            <button
                                disabled
                                className="h-8 w-16 mr-0.5 flex items-center justify-center bg-gradient-to-br from-purple-500 via-purple-800 to-purple-900 rounded-lg"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="1em"
                ...
                <tbody>
                    {filteredData.map((dato) => (
                        ...
                        >
                            ...
                            <td className="px-6 py-4">{dato.evaluator_name}</td>
