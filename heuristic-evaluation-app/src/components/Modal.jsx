...
const Modal = ({ isOpen, onClose }) => {
    return (
        <div
            ...
            tabIndex="-1"
            aria-hidden="true"
            className={`fixed bottom-0 right-0 z-50 overflow-x-hidden overflow-y-auto md:inset-0 ${
                isOpen ? "visible" : "hidden"
            }`}
        >
            <div className="absolute bottom-4 right-24 w-full max-w-2xl max-h-full">
